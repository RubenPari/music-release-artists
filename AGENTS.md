...
- Production target is a single DigitalOcean Droplet with Caddy, GHCR images, and DigitalOcean Managed PostgreSQL over verified TLS; keep one backend replica because cron jobs run in-process.
